public class ArraySlotAccess
{
	public static void main( String[] args ) {
		...
		// Displaying all the values in a array usually looks like this
		...
		// This displays the values in those slots, one at a time.
		...
		////////////////////////////////////////
		// Now does a using a loop make more sense?
